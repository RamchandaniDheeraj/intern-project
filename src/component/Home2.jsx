...
function Home2() {
    return (
        <>
            <section className='w-full py-11 bg-[#F2F4FA] md:flex'>
                ...
                <div className='md:w-[70%]  flex justify-between items-center md:relative '>
                    <div className='w-[80%] flex justify-center py-[20px]'>
                        <div className='w-[80%] md:h-[200px] bg-[#E1E1E1] rounded-[5px] relative'>
                            <div className='w-[100%] md:h-[200px]  absolute top-[-15%] left-[-5%] p-[10px] rounded-[5px] bg-[white]'>
            ...
            <div className=' w-full h-[580px] md:flex'>
                <div className='w-full md:w-[50%] bg-black relative'>
                    <img src={profile2} className='w-full md:h-[350px] lg:h-[450px] m-auto md:ml-8 mt-10 md:mt-32 lg:mt-16' />
                </div>
                <div className='w-full md:w-[50%] pl-3 bg-[#EBFAF4]'>
                    <h1 className='pl-16 mt-24 pb-6 text-4xl font-bold text-start '>Petrong & Pacioli</h1>
                    <p className=' font-medium text-sm leading-8 ml-16 text-start'>Pacioli is the flagship product at petrong software solutions, a tailored digital
                    ...
                    <div className='sm:mt-12 md:flex'>
                        ...
                        <button className='w-52 h-14 ml-14  bg-[#00D285] text-white pr-3 rounded-[100px] '>Demo Video</button>
                    </div>
                </div>
            </div>
        </>
